...
function checkbox(checked, onCheck, label_text) {
  ...
  var partial_arg_001 = /* :: */[
    Snabbdom_base.h("span", /* :: */[
          Snabbdom_base.set_style("font-weight", "bold"),
          /* :: */[
            (function (param) {
                return Snabbdom_base.set_text(label_text, param);
              }),
            /* [] */0
          ]
        ]),
  ...
  return Snabbdom_base.h("label", /* :: */[
              (function (param) {
                  return Snabbdom_base.add_children(partial_arg, param);
                }),
              /* [] */0
            ]);
}
...
function item(store, s) {
  ...
  var partial_arg_000 = Snabbdom_base.h("a", /* :: */[
        ...
        /* :: */[
          ...
          /* :: */[
            (function (param) {
                return Snabbdom_base.set_text(s, param);
              }),
            /* [] */0
          ]
        ]
  ...
  return Snabbdom_base.h("tr", /* :: */[
              Snabbdom_base.set_key(s),
              /* :: */[
                Snabbdom_base.set_style("line-height", "0"),
                /* :: */[
                  Snabbdom_base.set_style("opacity", "1"),
                  /* :: */[
                    Snabbdom_base.set_style("transition", "line-height 0.3s, opacity 0.3s"),
                    /* :: */[
                      Snabbdom_base.set_style_delayed("line-height", "1"),
                      /* :: */[
                        Snabbdom_base.set_style_remove("line-height", "0"),
                        /* :: */[
                          Snabbdom_base.set_style_remove("opacity", "0"),
                          /* :: */[
                            (function (param) {
                                return Snabbdom_base.add_children(partial_arg$1, param);
                              }),
                            /* [] */0
                          ]
                        ]
...
function view(store) {
  ...
  var partial_arg = "Hello " + Pervasives.string_of_int(state[/* count */0]);
  var partial_arg$1 = "This is some paragraph text. " + state[/* name */1];
  var partial_arg_000 = Snabbdom_base.h("h1", /* :: */[
        (function (param) {
            return Snabbdom_base.set_text(partial_arg, param);
          }),
        /* [] */0
      ]);
  var partial_arg_001 = /* :: */[
    Snabbdom_base.h("p", /* :: */[
          (function (param) {
              return Snabbdom_base.set_text(partial_arg$1, param);
            }),
          /* [] */0
        ]),
    /* :: */[
      Snabbdom_base.h("input", /* :: */[
      ...
      /* :: */[
        Snabbdom_base.h("button", /* :: */[
              ...
              /* :: */[
                (function (param) {
                    return Snabbdom_base.set_text("Add", param);
                  }),
                /* [] */0
              ]
            ]),
        /* :: */[
          Snabbdom_base.h("button", /* :: */[
                ...
                /* :: */[
                  (function (param) {
                      return Snabbdom_base.set_text("+", param);
                    }),
                  /* [] */0
                ]
              ]),
  ...
  var $js;
  if (state[/* show_items */4]) {
    var partial_arg$3 = List.map((function (param) {
            return item(store, param);
          }), state[/* items */2]);
    var partial_arg_000$1 = Snabbdom_base.h("table", /* :: */[
          Snabbdom_props.prop("border", "1"),
          /* :: */[
            (function (param) {
                return Snabbdom_base.add_children(partial_arg$3, param);
              }),
            /* [] */0
          ]
        ]);
    ...
    $js = (function (param) {
        return Snabbdom_base.add_children(partial_arg$4, param);
      });
  } else {
  ...
  return Snabbdom_base.h("div", /* :: */[
              (function (param) {
                  return Snabbdom_base.add_children(partial_arg$2, param);
                }),
              /* :: */[
                $js,
                /* [] */0
